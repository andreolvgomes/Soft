...
{
    public class ProdutosValidation : IProdutosValidation
    {
        private readonly IProdutosRepository _produtosRepository = null;

        public ProdutosValidation(IProdutosRepository produtosRepository)
        {
        ...
        public ValidationReturn ValidPro_codigo(string pro_codigo)
        {
            ...
            Produtos produto = _produtosRepository.Find(new { Pro_codigo = pro_codigo }, s => new { s.Pro_inativo });
            if (produto == null)
        ...
        public ValidationReturn ValidPro_codigoThereAreOtherEqual(Int64 pro_id, string pro_codigo)
        {
            ...
            Produtos produto = _produtosRepository.Find(new { Pro_codigo = pro_codigo }, s => new { s.Pro_descricao, s.Pro_id });
        ...
        public ValidationReturn ValidPro_descricaoThereAreOtherEqual(Int64 pro_id, string pro_descricao)
        {
            ...
            Produtos produto = _produtosRepository.Find(new { Pro_descricao = pro_descricao },
        ...
        {
            Produtos produto = _produtosRepository.Find(new { Pro_codigo = pro_codigo }, s => new { s.Pro_pvenda });
